...
$tel = substr(trim(strip_tags($_POST["telef4"])),0,19);
...
$mail2->Subject = 'консультация';
$mail2->Body = "консультация<br>Дата: {$data}<br>IP: {$ip}<br> Телефон: {$tel}";
$mail2->AltBody = "консультация \r\nДата: {$data} \r\n IP: {$ip} \r\n Телефон: {$tel}";
